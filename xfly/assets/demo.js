...
Demo.Configs = {
	 ...
	 * 工具的下拉菜单 HTML 模板。
	 */
	tool: '<a href="~/xfly/node/modulebuilder/index.html" target="_blank">模块打包工具</a>\
                <a href="~/xfly/tools/codehelper/index.html" target="_blank">代码工具</a>\
                <a href="~/xfly/tools/codesegments/specialcharacters.html" target="_blank">特殊字符</a>\
                <a href="~/xfly/tools/codesegments/regexp.html" target="_blank">常用正则</a>\
	...
	*/
	...
	Demo.Page = {
		...
		init: function () {
			...
			node = node.substr(0, node.length - configs.apps.length - "/assets/demo.js".length);
			Demo.baseUrl = node;
...
<input type="hidden" name="postback" value="' + Demo.Utils.encodeHTML(location.href) + '">\
	...
	Demo.writeHeader = function () {
		...
		// 输出 css 和 js
		document.write('<link type="text/css" rel="stylesheet" href="' + Demo.baseUrl + configs.apps + '/assets/demo.css" />');
		...
		if (!window.console)
			document.write('<script type="text/javascript" src="' + Demo.baseUrl + configs.apps + '/assets/firebug-lite/build/firebug-lite.js"></script>');

		// 非本地运行时，自动载入统计代码。
		if (!Demo.local) {
			document.write('<script type="text/javascript" src="' + Demo.baseUrl + configs.apps + '/assets/social.js"></script>');
		}
